...
\section{Experience}
\runsubsection{LifeBio\\}
\descript{AI Scientist}
\location{Feb 2021 - Current | Remote}
\vspace{\topsep}
\begin{tightitemize}
...
\location{Jun 2013 – Current | Las Vegas, NV}
...
\runsubsection{Portland General Electric\\}
\descript{ML Engineer}
\location{July 2020 - Dec 2020 | Portland, OR}
% \vspace{\topsep}
\begin{tightitemize}
...
\location{May 2019 - July 2020 | Beaverton, OR}
\begin{tightitemize}
...
\location{Jul 2018 - Jan 2019 | Santa Clara, CA}
\begin{tightitemize}
...
\runsubsection{Astound\\}
\descript{Machine Learning Scientist}
\location{Dec 2017 - Mar 2018 | Menlo Park, CA}
\begin{tightitemize}
