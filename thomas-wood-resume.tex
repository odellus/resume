...
\vspace{1 mm}
\href{mailto:thomas@wsynpon.com}{thomas@synpon.com} | 971.770.7914 % Your contact information
}
...
Python ({\it expert}) \\  Matlab ({\it expert}) \\R ({\it proficient})\\   C++ ({\it proficient}) \\  CUDA ({\it proficient}) \\ Spark ({\it beginner})
\sectionspace % Some whitespace after the section
...
\descript{ Chief Scientist}
\location{Jun 2013 – Current | Portland, OR}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
% \vspace{\topsep}
\begin{tightitemize}
%\item  Research and development of automated vertical hydroponic systems
\item  Design of natural language understanding (\textbf{NLU}) systems which read and answer questions using Wikipedia
% \item  Open source 3D printed robot arm research and development
\item  System identification and state estimation for humanoid robotics with MuJoCo
\item  Deep reinforcement learning agents that play Atari and Flash %games with OpenAI Universe and TensorFlow neural networks
