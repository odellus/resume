...
\hspace{-0.68 cm}\includegraphics[scale=0.05] {wgapl_logo.png}
\lastupdated % Print the Last Updated text at the top right

\namesection{Thomas}{Wood}{ % Your name
\urlstyle{same}\url{https://wgapl.github.io} \\ % Your website, LinkedIn profile or other web address
\vspace{1 mm}
\href{mailto:thomas@wgapl.com}{thomas@wgapl.com} | 206.678.6841 % Your contact information
}
...
\location{ Jan 2016 - Current | Redmond, WA}
\vspace{\topsep}
\begin{tightitemize}
\item Text Categorization for Azure Insight using AzureML.
\end{tightitemize}

\sectionspace

\runsubsection{Wood Gesellschaft Applied Physics Laboratory\\}
\descript{ Principal Research Scientist | Director}

\location{Jun 2013 – Current | Seattle, WA}
...
%\item Commercial hydroponic horticulture
\end{tightitemize}
